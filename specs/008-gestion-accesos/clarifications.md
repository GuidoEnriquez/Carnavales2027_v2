...
- **Estado de evidencia:** La aceptación API, login real, 2FA, rechazo de roles no permitidos, expiración, concurrencia, pruebas automatizadas de cliente y comprobación manual de las pantallas con teclado, emulación táctil y viewports están cubiertos.
