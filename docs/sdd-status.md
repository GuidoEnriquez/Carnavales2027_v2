...
- Spec 021 — Planilla del jurado v3 (Fase 3 del Plan Maestro): flujo tarjeta a tarjeta, radiogroup 1-10 real, "No se presentó" separado, barra de progreso/navegación fija, estado por fila y color de comparsa. En preparación de spec.
