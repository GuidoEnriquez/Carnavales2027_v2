...
- Spec 019: seguridad HTTP, resiliencia de persistencia, idempotencia de planilla y cadena de auditoría (Fase 1 del Plan Maestro). Endurecimiento sin cambios funcionales en votación/resultados.
